 ...
 */
final readonly class ViewRenderer implements RendererInterface
{
    private const string DEFAULT_VIEW = 'exception/error';
    private const string VIEW_PATTERN = 'exception/%s';
